...
final readonly class P_13_2Group extends DTO implements DomSerializableInterface
{
    ...
    public function toDom(): DOMDocument
    {
        ...
        $p_13_2group = $dom->createElementNS((string) XmlNamespace::Faktura->value, 'P_13_2Group');
        $dom->appendChild($p_13_2group);

        $p_13_2 = $dom->createElementNS((string) XmlNamespace::Faktura->value, 'P_13_2');
        $p_13_2->appendChild($dom->createTextNode((string) $this->p_13_2));

        $p_13_2group->appendChild($p_13_2);

        $p_14_2 = $dom->createElementNS((string) XmlNamespace::Faktura->value, 'P_14_2');
