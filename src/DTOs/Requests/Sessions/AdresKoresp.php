...
final class AdresKoresp extends AbstractDTO implements DomSerializableInterface, XmlNormalizableInterface
{
    /**
    ...
    public static function normalizeXmlArray(array $data): array
    {
        ...
        return Arr::only($data, ['KodKraju', 'AdresL1', 'AdresL2', 'gln']);
    }
}
