...
final class WysylkaZ extends AbstractDTO implements DomSerializableInterface, FromXmlArrayInterface
{
    /**
    ...
    public function toDom(): DOMDocument
    {
        ...
        $wysylkaZ = $dom->createElementNS((string) XmlNamespace::Fa3->value, 'WysylkaZ');
