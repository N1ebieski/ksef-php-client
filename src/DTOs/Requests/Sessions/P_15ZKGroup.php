...
final class P_15ZKGroup extends AbstractDTO implements DomSerializableInterface, XmlNormalizableInterface
{
    /**
    ...
    {
        $data['P15ZK'] = $data['P_15ZK'];

        return Arr::only($data, ['P15ZK', 'KursWalutyZK']);
    }
}
