...
final class P_PMarzy_3_2Group extends AbstractDTO implements DomSerializableInterface, FromXmlArrayInterface
{
    /**
    ...
    {
        return new self(
            p_PMarzy_3_2: isset($data['p_PMarzy_3_2']) ? P_PMarzy_3_2::from($data['p_PMarzy_3_2']) : P_PMarzy_3_2::Default,
        );
    }
}
