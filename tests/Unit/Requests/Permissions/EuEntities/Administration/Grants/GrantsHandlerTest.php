...
namespace N1ebieski\KSEFClient\Tests\Unit\Requests\Permissions\EuEntities\Administration\Grants;

use N1ebieski\KSEFClient\Requests\Permissions\EuEntities\Administration\Grants\GrantsRequest;
use N1ebieski\KSEFClient\Testing\Fixtures\Requests\Error\ErrorResponseFixture;
use N1ebieski\KSEFClient\Testing\Fixtures\Requests\Permissions\EuEntities\Administration\Grants\GrantsRequestFixture;
use N1ebieski\KSEFClient\Testing\Fixtures\Requests\Permissions\EuEntities\Administration\Grants\GrantsResponseFixture;
...
test('valid response', function (GrantsRequestFixture $requestFixture, GrantsResponseFixture $responseFixture): void {
    ...
    $response = $clientStub->permissions()->euEntities()->administration()->grants($requestFixture->data)->object();
...
test('invalid response', function (): void {
    ...
    expect(function () use ($responseFixture): void {
        ...
        $clientStub->permissions()->euEntities()->administration()->grants($requestFixture->data);
