...
namespace N1ebieski\KSEFClient\Tests\Unit\Requests\Permissions\Query\Entities\Grants;

use N1ebieski\KSEFClient\Requests\Permissions\Query\Entities\Grants\GrantsRequest;
use N1ebieski\KSEFClient\Testing\Fixtures\Requests\Error\ErrorResponseFixture;
use N1ebieski\KSEFClient\Testing\Fixtures\Requests\Permissions\Query\Entities\Grants\GrantsRequestFixture;
use N1ebieski\KSEFClient\Testing\Fixtures\Requests\Permissions\Query\Entities\Grants\GrantsResponseFixture;
...
test('valid response', function (GrantsRequestFixture $requestFixture, GrantsResponseFixture $responseFixture): void {
    ...
    $response = $clientStub->permissions()->query()->entities()->grants($requestFixture->data)->object();
...
test('invalid response', function (): void {
    ...
    expect(function () use ($responseFixture): void {
        ...
        $clientStub->permissions()->query()->entities()->grants($requestFixture->data);
