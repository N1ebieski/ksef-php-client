...
namespace N1ebieski\KSEFClient\Tests\Unit\Requests\Permissions\Query\Personal\Grants;

use N1ebieski\KSEFClient\Requests\Permissions\Query\Personal\Grants\GrantsRequest;
use N1ebieski\KSEFClient\Testing\Fixtures\Requests\Error\ErrorResponseFixture;
use N1ebieski\KSEFClient\Testing\Fixtures\Requests\Permissions\Query\Personal\Grants\GrantsRequestFixture;
use N1ebieski\KSEFClient\Testing\Fixtures\Requests\Permissions\Query\Personal\Grants\GrantsResponseFixture;
...
test('valid response', function (GrantsRequestFixture $requestFixture, GrantsResponseFixture $responseFixture): void {
    ...
    $response = $clientStub->permissions()->query()->personal()->grants($requestFixture->data)->object();
...
test('invalid response', function (): void {
    ...
    expect(function () use ($responseFixture): void {
        ...
        $clientStub->permissions()->query()->personal()->grants($requestFixture->data);
