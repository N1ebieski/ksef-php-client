...
namespace N1ebieski\KSEFClient\Tests\Unit\Requests\Sessions\Invoices\List;
...
test('valid response', function (ListRequestFixture $requestFixture, ListResponseFixture $responseFixture): void {
    ...
    $response = $clientStub->sessions()->invoices()->list($requestFixture->data)->object();
...
test('invalid response', function (): void {
    ...
    expect(function () use ($responseFixture): void {
        ...
        $clientStub->sessions()->invoices()->list($requestFixture->data);
