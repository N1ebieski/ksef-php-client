...
namespace N1ebieski\KSEFClient\Tests\Unit\Requests\Sessions\List;

use N1ebieski\KSEFClient\Requests\Sessions\List\ListRequest;
use N1ebieski\KSEFClient\Testing\Fixtures\Requests\Error\ErrorResponseFixture;
use N1ebieski\KSEFClient\Testing\Fixtures\Requests\Sessions\List\ListRequestFixture;
use N1ebieski\KSEFClient\Testing\Fixtures\Requests\Sessions\List\ListResponseFixture;
...
test('valid response', function (ListRequestFixture $requestFixture, ListResponseFixture $responseFixture): void {
    ...
    $response = $clientStub->sessions()->list($requestFixture->data)->object();
...
test('invalid response', function (): void {
    ...
    expect(function () use ($responseFixture): void {
        ...
        $clientStub->sessions()->list($requestFixture->data);
