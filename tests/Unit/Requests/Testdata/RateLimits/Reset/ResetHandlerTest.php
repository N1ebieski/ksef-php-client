...
namespace N1ebieski\KSEFClient\Tests\Unit\Requests\Testdata\RateLimits\Reset;

use N1ebieski\KSEFClient\Testing\Fixtures\Requests\Error\ErrorResponseFixture;
use N1ebieski\KSEFClient\Testing\Fixtures\Requests\Testdata\RateLimits\Reset\ResetResponseFixture;
...
test('valid response', function (ResetResponseFixture $responseFixture): void {
    ...
    $response = $clientStub->testdata()->rateLimits()->reset()->status();
...
test('invalid response', function (): void {
    ...
    expect(function () use ($responseFixture): void {
        ...
        $clientStub->testdata()->rateLimits()->reset();
